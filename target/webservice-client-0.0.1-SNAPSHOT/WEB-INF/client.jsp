...
<html>
    ...
    <head>
        <title>Webservice test client</title>
    </head>
    <body>
        ...
        <div class="shadow-lg container-fluid animated zoomIn text-center col-8 jumbotron mt-5">
            <div class="animated fadeIn delay-1s">
                      <h1 class="h3 mb-3 font-weight-normal">SOAP client test</h1>
                      <label for="ajaxgetsoapresposeinput" class="sr-only">Input student name</label>
                      <input type="text" id="ajaxgetsoapresposeinput" class="form-control mb-3" placeholder="Student name">
                      ...
                      <button id="ajaxgetsoapresposebutton" class="btn btn-info mb-3">Get student info</button>
